    ...
    <Grid container direction='column'>
      <Head>
        ...
        <meta
          name='description'
          key='description'
          content='Completely custom designed and built from scratch to be blazing fast. Optimized code, server-side rendering, and perfect responsive design | 99% Page Speed Score'
        />
        <meta
          property='og:title'
      ...
      >
        ...
        <Grid item className={classes.paragraphContainer}>
          <Typography variant='body1' align={matchesSM ? 'center' : undefined}>
            Knowledge is power, and data is the 21st Century gold. Analyzing
            this data can reveal hidden patterns and trends in your business,
